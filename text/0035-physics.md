...
We might want to support other physics engines such as the Unity Physics package in the future. A Physics engine which is stateless could help at improving rollback performance.